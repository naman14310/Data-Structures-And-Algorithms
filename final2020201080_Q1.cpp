...
{   cout<<endl<<"************************************   WELCOME TO AVL WORLD   ******************************************"<<endl;
   ...
   /* ------------------------------------------- TEST CASE 1 --------------------------------------------
    ...
    bool found = a.searchKey(31);
    if(found) cout<<endl<<endl<<"Node Found !";
    else cout<<endl<<endl<<"Node NOT Found !";

      found = a.searchKey(10);
    if(found) cout<<endl<<endl<<"Node Found !";
    else cout<<endl<<endl<<"Node NOT Found !";


   found = a.searchKey(51);
    if(found) cout<<endl<<endl<<"Node Found !";
    else cout<<endl<<endl<<"Node NOT Found !";

        int count = a.countOccurrance(31);
    cout<<endl<<endl<<"Count Occurances : "<<count;

            count = a.countOccurrance(10);
    cout<<endl<<endl<<"Count Occurances : "<<count;

    cout<<endl<<endl<<"Lower Bound : "<<a.lowerbound(12);
    cout<<endl<<endl<<"Lower Bound : "<<a.lowerbound(10);
    cout<<endl<<endl<<"Lower Bound : "<<a.lowerbound(11);
    cout<<endl<<endl<<"Lower Bound : "<<a.lowerbound(9);

    cout<<endl<<endl<<"Upper Bound : "<<a.upperbound(11);
     cout<<endl<<endl<<"Upper Bound : "<<a.upperbound(10);
      cout<<endl<<endl<<"Upper Bound : "<<a.upperbound(52);
       cout<<endl<<endl<<"Upper Bound : "<<a.upperbound(9);

    cout<<endl<<endl<<"Closest Element : "<<a.closest(11);
        cout<<endl<<endl<<"Closest Element : "<<a.closest(51);
            cout<<endl<<endl<<"Closest Element : "<<a.closest(57);

    for(int i=11; i>0; i--)
    cout<<endl<<endl<<"3nd largest Element : "<<a.klargest(i);

    cout<<endl<<endl<<"No of elements that lies within the given range are : "<<a.range(9 , 12);
        cout<<endl<<endl<<"No of elements that lies within the given range are : "<<a.range(10 , 12);
            cout<<endl<<endl<<"No of elements that lies within the given range are : "<<a.range(31, 31);
                cout<<endl<<endl<<"No of elements that lies within the given range are : "<<a.range(52 , 60);*/
